      ...
      <div className="bg-white rounded-lg shadow-xl p-8 max-w-2xl w-full">
        ...
        <div className="mt-8 p-4 bg-blue-50 rounded-lg">
          ...
          <ul className="text-sm text-gray-700 space-y-1">
            ...
            <li>✓ AI adapts to your communication style (efficient, chatty, confused, edge-case)</li>
            <li>✓ Get follow-up questions based on your answer depth</li>
            <li>✓ Receive personalized feedback with improvement tips</li>
